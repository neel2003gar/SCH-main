...
export default function FindOccHealthClinicPage() {
  ...
  const clinics = [
    { name: 'Toronto Occupational Health', address: '100 King St W, Toronto, ON M5X 1A9', phone: '+1 (416) 555-0400', hours: 'Mon-Fri: 8am-6pm' },
    { name: 'Vancouver Work Health Clinic', address: '200 Burrard St, Vancouver, BC V6C 3L6', phone: '+1 (604) 555-0500', hours: 'Mon-Fri: 7am-7pm' },
    { name: 'Calgary Workplace Wellness', address: '300 5th Ave SW, Calgary, AB T2P 3C4', phone: '+1 (403) 555-0600', hours: 'Mon-Fri: 8am-5pm' },
  ];
      ...
      <section className="py-24" style={{ backgroundColor: '#0F2A45' }}>
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <h1 className="font-serif text-white mb-6" style={{ fontFamily: 'DM Serif Display', fontSize: '44px' }}>
            Find an Occupational Health Clinic
          </h1>
          <p className="text-white/70 text-lg max-w-2xl mx-auto mb-8">
            Workplace health services at your convenience — on-site or at one of our partner locations.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="mb-6">
            <p style={{ color: '#3D3D3A' }}>
              <strong>{clinics.length}</strong> occupational health clinics found
            </p>
          </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-2 text-sm mb-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span style={{ color: '#3D3D3A' }}>{clinic.hours}</span>
                      </div>
                    </div>
                  </div>
      ...
      <section className="py-20" style={{ backgroundColor: '#0F2A45' }}>
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <h2 className="font-serif text-white mb-4" style={{ fontFamily: 'DM Serif Display', fontSize: '32px' }}>
            Prefer on-site services?
          </h2>
          <p className="text-white/70 mb-8">
            We bring occupational health services directly to your workplace.
          </p>
          <a
            href="/get-quote"
