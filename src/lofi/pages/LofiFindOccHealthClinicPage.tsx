...
export default function LofiFindOccHealthClinicPage() {
  return (
    <>
      {/* Hero */}
      <section className="bg-gray-200 border-b-2 border-gray-400 py-16 px-4">
        <div className="max-w-[1200px] mx-auto text-center">
          <div className="border-2 border-gray-500 p-6 bg-white inline-block mb-4">
            <h1 className="text-3xl md:text-4xl font-bold">[FIND AN OCCUPATIONAL HEALTH CLINIC]</h1>
          </div>
          <div className="border border-gray-400 p-4 bg-white max-w-2xl mx-auto">
            <p className="text-sm text-gray-600">[Locate an occupational health clinic near you]</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1000px] mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="border-2 border-gray-400 bg-white">
              <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="md:col-span-2 p-6 border-b-2 md:border-b-0 md:border-r-2 border-gray-400">
                  <div className="font-bold text-lg mb-3">[Occ Health Clinic Name 1]</div>
                  ...
                  <div className="mt-4 pt-4 border-t border-gray-300">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <div className="border border-gray-300 px-2 py-1 text-xs">[Ergonomics]</div>
                      <div className="border border-gray-300 px-2 py-1 text-xs">[Job Analysis]</div>
                      <div className="border border-gray-300 px-2 py-1 text-xs">[Wellness]</div>
                    </div>
                  </div>
                </div>
            ...
            <div className="border-2 border-gray-400 bg-white">
              <div className="grid grid-cols-1 md:grid-cols-3">
                <div className="md:col-span-2 p-6 border-b-2 md:border-b-0 md:border-r-2 border-gray-400">
                  <div className="font-bold text-lg mb-3">[Occ Health Clinic Name 2]</div>
                  <div className="space-y-2 text-sm text-gray-600">
                    <div className="flex gap-2">
                      <div className="border border-gray-300 px-2 py-1 text-xs">[Icon]</div>
                      <div>
